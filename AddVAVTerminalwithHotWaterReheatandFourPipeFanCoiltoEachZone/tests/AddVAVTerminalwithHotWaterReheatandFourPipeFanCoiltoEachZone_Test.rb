...
class AddVAVTerminalwithHotWaterReheatandFourPipeFanCoiltoEachZone_Test < Test::Unit::TestCase

  
  def test_AddVAVTerminalwithHotWaterReheatandFourPipeFanCoiltoEachZone
     
    # create an instance of the measure
    measure = AddVAVTerminalwithHotWaterReheatandFourPipeFanCoiltoEachZone.new
