...
class ReduceBuildingLightingPowerDensity_Test < Test::Unit::TestCase

  
  def test_ReduceBuildingLightingPowerDensity
     
    # create an instance of the measure
    measure = ReduceBuildingLightingPowerDensity.new
