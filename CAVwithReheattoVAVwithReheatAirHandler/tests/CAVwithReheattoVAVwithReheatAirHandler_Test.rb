...
class CAVwithReheattoVAVwithReheatAirHandler_Test < Test::Unit::TestCase

  
  def test_CAVwithReheattoVAVwithReheatAirHandler
     
    # create an instance of the measure
    measure = CAVwithReheattoVAVwithReheatAirHandler.new
