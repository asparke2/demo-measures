...
#start the measure
class AddSys10ElectricWarmAirFurnace < OpenStudio::Ruleset::ModelUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "AddSys10ElectricWarmAirFurnace"
  end
...
AddSys10ElectricWarmAirFurnace.new.registerWithApplication