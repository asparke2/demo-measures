...
class InstallAeratorsonFaucetstoReduceWaterFlowRate_Test < Test::Unit::TestCase

  
  def test_InstallAeratorsonFaucetstoReduceWaterFlowRate
     
    # create an instance of the measure
    measure = InstallAeratorsonFaucetstoReduceWaterFlowRate.new
