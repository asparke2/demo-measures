...
class RemoveAllAirTerminalSingleDuctVAVReheatCoils_Test < Test::Unit::TestCase

  
  def test_RemoveAllAirTerminalSingleDuctVAVReheatCoils
     
    # create an instance of the measure
    measure = RemoveAllAirTerminalSingleDuctVAVReheatCoils.new
