...
class SetDefrostEnergyCorrectionCurveforRefrigeratedCases_Test < Test::Unit::TestCase

  
  def test_SetDefrostEnergyCorrectionCurveforRefrigeratedCases
     
    # create an instance of the measure
    measure = SetDefrostEnergyCorrectionCurveforRefrigeratedCases.new
