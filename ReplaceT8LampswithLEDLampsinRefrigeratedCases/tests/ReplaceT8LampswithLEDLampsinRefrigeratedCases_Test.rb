...
class ReplaceT8LampswithLEDLampsinRefrigeratedCases_Test < Test::Unit::TestCase

  
  def test_ReplaceT8LampswithLEDLampsinRefrigeratedCases
     
    # create an instance of the measure
    measure = ReplaceT8LampswithLEDLampsinRefrigeratedCases.new
