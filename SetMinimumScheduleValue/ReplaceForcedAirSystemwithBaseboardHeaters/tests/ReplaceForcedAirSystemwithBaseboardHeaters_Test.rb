...
class ReplaceForcedAirSystemwithBaseboardHeaters_Test < Test::Unit::TestCase

  
  def test_ReplaceForcedAirSystemwithBaseboardHeaters
     
    # create an instance of the measure
    measure = ReplaceForcedAirSystemwithBaseboardHeaters.new
