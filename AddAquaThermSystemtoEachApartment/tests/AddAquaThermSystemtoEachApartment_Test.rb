...
class AddAquaThermSystemtoEachApartment_Test < Test::Unit::TestCase

  
  def test_AddAquaThermSystemtoEachApartment
     
    # create an instance of the measure
    measure = AddAquaThermSystemtoEachApartment.new
