...
class SetMinimumVAVTerminalFlowFraction_Test < Test::Unit::TestCase

  
  def test_SetMinimumVAVTerminalFlowFraction
     
    # create an instance of the measure
    measure = SetMinimumVAVTerminalFlowFraction.new
