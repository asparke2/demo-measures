...
class RemoveOrphanedControllerWaterCoils_Test < Test::Unit::TestCase

  
  def test_RemoveOrphanedControllerWaterCoils
     
    # create an instance of the measure
    measure = RemoveOrphanedControllerWaterCoils.new
