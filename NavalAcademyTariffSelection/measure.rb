...
#start the measure
class NavalAcademyTariffSelection < OpenStudio::Ruleset::WorkspaceUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "NavalAcademyTariffSelection"
  end
...
NavalAcademyTariffSelection.new.registerWithApplication
