...
#start the measure
class ESTCPDemoUtilityRates < OpenStudio::Ruleset::WorkspaceUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "ESTCP Demo Utility Rates"
  end
  ...
  def arguments(workspace)
    ...
    elec_chs << "AFA_Electricity"
    elec_chs << "FtJackson_Electricity"
    elec_chs << "FtBliss_Electricity"
    elec_chs << "Tyndall_Electricity"
    elec_chs << "Monterey_Electricity"
    ...
    gas_chs << "AFA_Gas"
    gas_chs << "FtJackson_Gas" 
    gas_chs << "FtBliss_Gas"   
    gas_chs << "Tyndall_Gas"   
    gas_chs << "Monterey_Gas"    
...
ESTCPDemoUtilityRates.new.registerWithApplication
