...
#start the measure
class RemoveCurlyBracesfromObjectNames < OpenStudio::Ruleset::ModelUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "RemoveCurlyBracesfromObjectNames"
  end
  ...
  def run(model, runner, user_arguments)
    ...
    #loop through all model objects, removing curly braces from object names
...
RemoveCurlyBracesfromObjectNames.new.registerWithApplication