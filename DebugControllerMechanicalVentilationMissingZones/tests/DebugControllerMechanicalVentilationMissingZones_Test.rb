...
class DebugControllerMechanicalVentilationMissingZones_Test < Test::Unit::TestCase

  
  def test_DebugControllerMechanicalVentilationMissingZones
     
    # create an instance of the measure
    measure = DebugControllerMechanicalVentilationMissingZones.new
