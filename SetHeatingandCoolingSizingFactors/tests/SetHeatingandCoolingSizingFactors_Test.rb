...
class SetHeatingandCoolingSizingFactors_Test < Test::Unit::TestCase

  
  def test_SetHeatingandCoolingSizingFactors
     
    # create an instance of the measure
    measure = SetHeatingandCoolingSizingFactors.new
