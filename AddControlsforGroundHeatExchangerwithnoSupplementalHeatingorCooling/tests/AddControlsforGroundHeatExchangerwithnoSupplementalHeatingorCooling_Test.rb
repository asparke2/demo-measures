...
class AddControlsforGroundHeatExchangerwithnoSupplementalHeatingorCooling_Test < Test::Unit::TestCase

  
  def test_AddControlsforGroundHeatExchangerwithnoSupplementalHeatingorCooling
     
    # create an instance of the measure
    measure = AddControlsforGroundHeatExchangerwithnoSupplementalHeatingorCooling.new
