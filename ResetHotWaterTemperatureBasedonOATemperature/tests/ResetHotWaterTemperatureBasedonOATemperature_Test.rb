...
class ResetHotWaterTemperatureBasedonOATemperature_Test < Test::Unit::TestCase

  
  def test_ResetHotWaterTemperatureBasedonOATemperature
     
    # create an instance of the measure
    measure = ResetHotWaterTemperatureBasedonOATemperature.new
