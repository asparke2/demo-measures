...
#start the measure
class AddEconomizerToAirHandler < OpenStudio::Ruleset::ModelUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "AddEconomizerToAirHandler"
  end
...
AddEconomizerToAirHandler.new.registerWithApplication