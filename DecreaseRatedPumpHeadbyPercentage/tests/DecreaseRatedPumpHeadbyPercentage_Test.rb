...
class DecreaseRatedPumpHeadbyPercentage_Test < Test::Unit::TestCase

  
  def test_DecreaseRatedPumpHeadbyPercentage
     
    # create an instance of the measure
    measure = DecreaseRatedPumpHeadbyPercentage.new
